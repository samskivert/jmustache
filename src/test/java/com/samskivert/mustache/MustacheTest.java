...
public class MustacheTest
{
    ...
    public void testStandardsModeWithNoParentContextSearching () {
        ...
        String result = Mustache.compiler(Options.builder().setStandardsMode(true).build()).compile(tmpl).execute(new HashMap() {{
            put("parent", new Object());
            put("parentProperty", "bar");
        }});
    }
